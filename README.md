...
A página agora inclui uma seção para o visitante informar o nome e escrever uma mensagem de carinho.
Nesta versão estática, as mensagens são guardadas no `localStorage` do navegador em que foram enviadas e aparecem logo abaixo do formulário nesse mesmo dispositivo.

Para receber e centralizar mensagens de todos os convidados, conecte o formulário futuramente a um serviço de formulários, API ou banco de dados.
